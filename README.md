## husarion_components_description (jazzy) - 0.1.1-2

The packages in the `husarion_components_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy husarion_components_description` on `Mon, 29 Jun 2026 10:15:49 -0000`
...
## husarion_components_description (jazzy) - 0.1.1-1

The packages in the `husarion_components_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy husarion_components_description` on `Mon, 29 Jun 2026 10:10:14 -0000`
...
## husarion_components_description (humble) - 0.1.0-1

The packages in the `husarion_components_description` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble husarion_components_description` on `Fri, 12 Dec 2025 12:10:11 -0000`
...
- catkin_pkg version: `1.1.0`
- rosdep version: `0.26.0.0`
- rosdistro version: `1.0.1`
- vcstools version: `0.1.42`


## husarion_components_description (jazzy) - 0.1.0-1

The packages in the `husarion_components_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy husarion_components_description` on `Fri, 12 Dec 2025 11:51:08 -0000`
...
## husarion_components_description (jazzy) - 0.0.2-2
